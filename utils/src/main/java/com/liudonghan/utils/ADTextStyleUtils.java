...
public class ADTextStyleUtils {
    ...
    public void setCompoundDrawables(Context context, TextView textView, @DrawableRes int left, @DrawableRes int top, @DrawableRes int right, @DrawableRes int bottom) {
        setCompoundDrawables(context, textView, left, top, right, bottom, 10);
    }
...
//    }
    ...
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder findView(TextView textView) {
         ...
         * @return Builder
         */
        public Builder textDescription(String description) {
            this.description = description;
            return this;
        }

        /**
         * todo 原始属性（ 文字大小、文字眼阿瑟 ）
         *
         * @param originSize  大小
         * @param originColor 颜色
         * @return Builder
         */
        public Builder originAttr(int originSize, @ColorRes int originColor) {
         ...
         * @return Builder
         */
        public Builder changeAttr(int changeSize, @ColorRes int changeColor) {
         ...
         * @return Builder
         */
        public Builder drawablesIconAttr(@DrawableRes int drawablesIcon) {
         ...
         * @return Builder
         */
        public Builder drawablesIconAttr(@DrawableRes int drawablesIcon, Direction direction) {
         ...
         * @return Builder
         */
        public Builder drawablesIconAttr(@DrawableRes int drawablesIcon, Direction direction, int drawablesPadding) {
         ...
         * @return Builder
         */
        public Builder changePosition(int start, int end) {
            this.start = start;
            this.end = end;
            return this;
        }
         ...
         * @return Builder
         */
        public Builder drawablesSize(int width, int height) {
            this.width = width;
            this.height = height;
            return this;
        }
